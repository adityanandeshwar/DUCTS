...
<html lang="en">
  ...
  <body class="violetgradient">
        ...
        <div class="mycardstyle">
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                        <label type="text" class="formlabel"> Chemical Name </label>
                        <input type="text" class="forminput" id="prodname" required>
                        
                        <label type="text" class="formlabel"> Chemical type </label>
                        <select name="cars" class="forminput" id="chem_type">
                          <option value="Class A(Eco friendly)">Class A</option>
                          <option value="Class B(Need to be precautions)">Class B</option>
                          <option value="Class C(Store in specific conditions)">Class C</option>
                          <option value="Class D(Hazardous)">Class D</option>
                        </select>
                        <style>
                        ...
                        <label type="text" class="formlabel"> NOC Number </label>
                        <input type="text" class="forminput" id="nocnumber" required>
    ...
    $('#form1').on('submit', function(event) {
        ...
        username = $('#user').val(); 
        chemtype = $('#chem_type').val();
        nocnumber= $('#nocnumber').val();
        prodname=prodname+"<br>Registered By: "+username + "<br>Chemical Type : " + chemtype+ "<br>NOC Number : " + nocnumber;
